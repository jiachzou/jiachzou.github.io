...
<span style="background-color: navy; color: white; padding: 2px 5px;">(I) Statistical learning of large panel data</span><br>
...
* **Learning Bipartite Relationship Graph with Applications for National Kidney Allocation Policy Evaluations** <br>
	...
	<span style="background-color: navy; color: white; padding: 2px 5px;"> Statistical learning of large panel data</span> <span style="background-color: #228B22; color: white; padding: 2px 5px;"> Improving healthcare with ML</span>
...
* **Improving Deceased Donor Kidney Allocation with Machine Learning**<br>
	...
	<span style="background-color: #228B22; color: white; padding: 2px 5px;"> Improving healthcare with ML</span> <br>
